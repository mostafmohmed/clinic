...
<?php  require_once '../helper/creddp.php';
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="d-flex gap-3 flex-wrap justify-content-center" role="group">
                        ...
                        <?php } ?>
                        <?php  if(chekIslogin()){?>
                        <a type="button" class="btn btn-outline-light navigation--button" href="../login.php">logout</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
    ...
    <form  method="POST" action="" >
                <div class="dropdown">
<?php   $dp=new DB("localhost","root",''); $l=  $dp->getdata('doctors',"DISTINCT city")  ?>
                    ...
                    <?php    foreach($l as $v){ ?>
                        <li><input class="dropdown-item" type="submit" value="  <?php echo $v['city'] ?>" name='<?php echo $v['city'] ?>' href="#"></li>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item"  name='caro'>Cairo</a></li>
            ...
            <div class="doctors-grid">
                ...
                <?php  if((isset($_POST) and !empty($_POST))   ) {
                   $h=$_GET['id'];
                   $_SESSION['return-majors']=$h;
                    $d= array_keys($_POST)[0];
                    // echo $d;
                     $l=  $dp->getdata('doctors','*',"city='$d' AND major_id=$h ") ;
                     $g= $dp->getdata('major','*',"id=$h");
                     ?>
                ...
                <div class="card p-2" style="width: 18rem;">
                    <img src="../uplode/<?php  echo $l[$k]['image']; ?>" class="card-img-top rounded-circle card-image-circle"
                        alt="major">
                        <div class="card-body d-flex flex-column gap-1 justify-content-center">
                  
                        <h6 class="card-title fw-bold text-center"> <?php echo $g[0]['title']  ?>  </h6>
                        <h4 class="card-title fw-bold text-center"><?php   echo $l[$k]['name'];     ?></h4>
                ...
                <?php }} else{  
                     $s= $_GET['id'];
                     $_SESSION['return-majors']=$s;
                     $l=  $dp->getdata('doctors','*',"major_id =$s");   $g= $dp->getdata('major','*',"id = $s")   ?>
                    <?php 
                         foreach($l as $k=> $v){
                    ...
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        ...
                        <h6 class="card-title fw-bold text-center"> <?php echo $g[0]['title']  ?>  </h6>
                        <h4 class="card-title fw-bold text-center"><?php   echo $l[$k]['name'];     ?></h4>
                        <a href="./doctor.php?id= <?php echo $l[$k]['id'] ?>" doctor.php" class="btn btn-outline-primary card-button">Book an
                            appointment</a>
