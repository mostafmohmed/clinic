    ...
    <div class="page-wrapper">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column gap-3 account-form mx-auto mt-5">
                <form class="form"   method="POST" action="action/rejaster.php" >
                    <div class="form-items">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="pasword" id="password" required>
                        </div>
                    </div>
                    <input type="submit" class="btn btn-primary" value="Register" name='submit'  >supmet </button>
                </form>
