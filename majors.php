...
<body>
    <div class="page-wrapper">
     ...
     <?php   $dp=new DB("localhost","root",''); $l=  $dp->getdata('major')?>
        <div class="container">
            ...
            <?php foreach ($l as $v){ ?>
                <div class="card p-2" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center"><?php echo $v['title']??null ?></h4>
                        <a href="./doctors/index.php?id= <?php echo $v['id']?>"  value="Browse Doctors<?php echo $v['id']?>" class="btn btn-outline-primary card-button">Broser doctor </a>
                    </div>
                </div>
                <?php }?>
