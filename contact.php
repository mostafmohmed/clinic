    ...
    <div class="page-wrapper">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column gap-3 account-form mx-auto mt-5">
                <form class="form"  action="contact-action.php" method="POST" >
                    <div class="form-items">
                        <div class="mb-3">
                            <label class="form-label required-label"  for="name">Name</label>
                            <?php echo $_SESSION['error-massage']['name']??null ?>
                            <input type="text" class="form-control" name="name" id="name" >
                        </div>
                        <div class="mb-3">
                            <label class="form-label required-label" for="phone">Phone</label>
                            <?php echo $_SESSION['error-massage']['phone']??null ?>
                            <input type="text" class="form-control" name="phone" id="phone" >
                        </div>
                        <div class="mb-3">
                            <label class="form-label required-label" for="email">Email</label>
                            <?php echo $_SESSION['error-massage']['email']??null ?>
                            <input type="text" class="form-control" name="email" id="email" >
                        </div>
                        <div class="mb-3">
                            <label class="form-label required-label" for="subject">subject</label>
                            <input type="text" class="form-control" name="subject" id="email" >

                            <?php echo $_SESSION['error-massage']['subject']??null ?>
                            
                        </div>
                        <div class="mb-3">
                            <label class="form-label required-label" for="message">message</label>
                            <?php echo $_SESSION['error-massage']['massage'] ?>
