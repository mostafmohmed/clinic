    ...
    <div class="page-wrapper">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-wrap gap-4 justify-content-center">
              ...
              <?php    $d=new DB("localhost","root",'');
$f=$d->getdata('major');  ?>
             <?php foreach($f as $v){ ?>
                <div class="card p-2" style="width: 18rem;">
                    <img src="uplode/1.png" class="card-img-top rounded-circle card-image-circle"
                        alt="major">
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center"><?php echo $v['title'] ?></h4>
                        <a href="./doctors/index.php?id=<?php echo  $v['id']?>" class="btn btn-outline-primary card-button">Browse Doctors</a>
                    </div>
                </div>
                <?php } ?>
            </div>
            <h2 class="h1 fw-bold text-center my-4">docs</h2>
...
try {
  ...
  $stmt = $conn->query("SELECT doctors.*, major.title AS major_title
  FROM doctors
         ...
         "
                      <?php   foreach($k as $v){ ?>
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                <img src="uplode/<?php echo $v['image'] ?>" class="card-img-top rounded-circle card-image-circle"
                                    alt="major">
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    <h4 class="card-title fw-bold text-center"><?php echo $v['name'] ?></h4>
                                    <h6 class="card-title fw-bold text-center"><?php echo $v['major_title'] ?></h6>
                                    <a href="./doctors/doctor.php?id=<?php echo $v['id'] ?>" class="btn btn-outline-primary card-button">Book an
                                        appointment</a>
                                </div>
                            </div>
                        </li>
